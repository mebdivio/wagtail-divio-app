...
class List(Question):
    ...
    def __init__(
        ...
        super().__init__(
            name, message, choices, default, ignore, validate, hints=hints, other=other
        )
...
class Path(Text):
    ...
    def __init__(self, name, default=None, path_type="any", exists=None, **kwargs):
        ...
        if default is not None:
            try:
                ...
                raise ValueError(
                    "Default value '{}' is not valid based on "
    ...
    def validate(self, current: str):
        ...
        if (self._exists is True and not path.exists()) or (
            self._exists is False and path.exists()
        ):
            raise errors.ValidationError(current)
