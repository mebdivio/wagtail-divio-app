...
data = dict(
    ...
    query_dump=cs.OrderedDict(
        [("key1", "тест1"), ("key2", "тест2"), ("key3", "тест3"), ("последний", None)]
    ),
    ids=cs.OrderedDict(),
    a=[1, None, "asd", "не-ascii"],
    b=3.5,
    c=None,
    d=test_const.dispatch,
...
class DumpTests(unittest.TestCase):
    ...
    def test_ids(self):
        ...
        if not unidecode:
            self.assertIn("id в уникоде: &ids_-_id2__id00", b)
    ...
    def test_str_styles(self):
        ...
        self.assertTrue(
            pyaml.dump("waka waka", string_val_style="|").startswith("|-\n")
        )
    ...
    def test_ruamel_yaml(self):
        try:
            ...
            self.skipTest("No ruamel.yaml module to test it")
    ...
    def test_vspacing_limits(self):
        ...
        self.assertEqual(
            self.empty_line_list(ys), [1, 11, 21, 31, 41, 51, 61, 71, 81, 91]
        )
    ...
    def test_split_block_types(self):
        ...
        self.assertEqual(
            self.empty_line_list(ys), [1, 4, 7, 10, 12, 16, 19, 21, 23, 27, 32]
        )
    ...
    def test_anchor_cutoff(self):
        ...
        for c in "&", r"\*":
            self.assertTrue(m := re.search(rf"(?<= ){c}\S+", ys))
    ...
    def test_group_oneline_values(self):
        ...
        self.assertEqual(
            self.empty_line_list(ys2), [1, 4, 6, 9, 11, 13, 15, 17, 21, 23, 25, 27, 29]
        )
    ...
    def test_repr_undefined(self):
        class TestType1:
            def __repr__(self):
                return large_yaml.decode()

        class TestType2:
            def __repr__(self):
                return "# should end up quoted" + " " * 100
